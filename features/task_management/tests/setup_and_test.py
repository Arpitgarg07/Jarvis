...
def test_basic_functionality():
    ...
    task_id1 = task_manager.add_task("Test task 1", "This is a test task", Priority.NORMAL)
    task_id2 = task_manager.add_task("Urgent test task", "This is urgent", Priority.URGENT)
    ...
    print(f"   ✅ Summary: {summary['pending_tasks']} pending, {summary['completed_tasks']} completed")
...
def test_date_handling():
    ...
    for deadline in test_deadlines:
        try:
            task_id = task_manager.add_task(f"Test task with deadline {deadline}", deadline=deadline)
