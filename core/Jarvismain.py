            ...
            while True:
                ...
                # *Focus Mode Function.
                    ...
                    if a == 1:
                        ...
                        focus_mode_path = os.path.abspath("FocusMode.py")
                        if os.path.exists(focus_mode_path):
                            os.startfile(focus_mode_path)
                        else:
                            Speak("FocusMode.py not found.")
                        exit()
                    else:
                        pass
                ...
                #! For exit from Jarvis.
                    ...
                    # Note: random.choice is safe here as it's only for selecting goodbye messages
                    # and not used for security-sensitive operations
